      ...
      <div className="relative z-10">
        ...
        <div className="max-w-8xl mx-auto px-6 py-16  md:px-14">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 group cursor-pointer">
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                    <span className="text-white text-2xl font-bold">A</span>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl blur-lg opacity-50 group-hover:opacity-75 transition-opacity"></div>
                </div>
                <h3 className="text-3xl font-bold">{t('footer.abyTicket')}</h3>
              </div>
              ...
              <div className="flex gap-3">
                {[{ icon: Facebook, href: 'https://facebook.com' },
                  ...
                  <a key={idx} href={social.href} target="_blank" rel="noopener noreferrer" className="w-11 h-11 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-gradient-to-br hover:from-primary-500 hover:to-primary-600 hover:border-transparent hover:scale-110 transition-all duration-300">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-500">{t('footer.quickLinks')}</h4>
              <ul className="space-y-3">
                {['aboutUs', 'ourFleet', 'destinations', 'contact'].map(link => (
                  <li key={link}>
                    <a href="#" className="text-gray-400 hover:text-white hover:translate-x-1 inline-flex items-center gap-2 transition-all duration-200 group">
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-lg font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-500">{t('footer.mainOffice')}</h4>
              <div className="space-y-4">
                <div className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 text-sm inline-flex items-center gap-1 transition-colors">
                      {t('footer.viewMap')} →
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group">
                  ...
                  <a href="tel:+250792888980" className="text-gray-400 hover:text-white transition-colors text-sm">{t('footer.phone')}</a>
                </div>
            ...
            {/* Newsletter */}
            <div>
              <h4 className="text-lg font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-500">{t('footer.newsletter')}</h4>
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <button type="submit" className="w-full px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-primary-500/30 transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-gray-500 hover:text-primary-400 transition-colors text-sm">{t('footer.privacyPolicy')}</a>
              <a href="#" className="text-gray-500 hover:text-primary-400 transition-colors text-sm">{t('footer.terms')}</a>

              {/* Language Selector */}
              <div className="relative">
                <button onClick={() => setLangOpen(!langOpen)} className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-all text-sm">
